  ...
  const isPhone = useStore((state)=>state.isPhone);
    return(
        ...
        <div className="grid grid-rows-6 gap-2">
          ...
          <Image src={"/dashboard.png"} className="mr-2" width={21} height={21}  alt="logoIcon"></Image>
          <div className="font-bold ">
            Dashboard
          </div>
          </div>
          <div className="flex flex-row h-[48px] hover:bg-gray-50 text-dashboardText hover:text-sidebarHoverTextColor cursor-pointer items-center pl-2 rounded-[6px]">
          <Image src={"/student.png"} className=" mr-2" width={18} height={18}  alt="logoIcon"></Image>
          <div className=" font-semibold">
            Student
          </div>
          </div>
          <div className="flex flex-row h-[48px] hover:bg-gray-50 text-dashboardText hover:text-sidebarHoverTextColor cursor-pointer items-center pl-2 rounded-[6px]">
          <Image src={"/chapter.png"} className=" mr-2" width={18} height={18}  alt="logoIcon"></Image>
          <div className="font-semibold">
            Chapter
          </div>
          </div>
          <div className="flex flex-row h-[48px] hover:bg-gray-50 text-dashboardText hover:text-sidebarHoverTextColor cursor-pointer items-center pl-2 rounded-[6px]">
          <Image src={"/help.png"} className=" mr-2" width={22} height={22}  alt="logoIcon"></Image>
          <div className="font-semibold">
            Help
          </div>
          </div>
          <div className="flex flex-row h-[48px] hover:bg-gray-50 text-dashboardText hover:text-sidebarHoverTextColor cursor-pointer items-center pl-2 rounded-[6px]">
          <Image src={"/report.png"} className=" mr-2" width={22} height={22}  alt="logoIcon"></Image>
          <div className="font-semibold">
            Report
          </div>
          </div>
          <div className="flex flex-row h-[48px] hover:bg-gray-50 text-dashboardText hover:text-sidebarHoverTextColor cursor-pointer items-center pl-2 rounded-[6px]">
          <Image src={"/settings.png"} className="mr-2" width={18} height={18}  alt="logoIcon"></Image>
          <div className="font-semibold">
            Settings
          </div>
          </div>
