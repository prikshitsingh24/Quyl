  ...
  return (
    <div className="h-screen w-full bg-background grid grid-cols-[1fr_6fr] gap-2 text-black">
      <div className="bg-foreground">
        ...
        <Image src={logo} alt="logoIcon"></Image>
        </div>
        <div className="grid grid-rows-6 gap-2">
          <div className="flex flex-row h-[48px] items-center pl-2 rounded-[6px]">
          <Image src={dashboard} className="h-[18px] w-[18px] mr-2" alt="logoIcon"></Image>
          <div className="font-bold text-dashboardText">
            Dashboard
          </div>
          </div>
          <div className="flex flex-row h-[48px] bg-gray-50 items-center pl-2 rounded-[6px]">
          <Image src={student} className="h-[18px] w-[18px] mr-2" alt="logoIcon"></Image>
          <div className=" font-semibold text-dashboardText">
            Student
          </div>
          </div>
          <div className="flex flex-row h-[48px] items-center pl-2 rounded-[6px]">
          <Image src={chapter} className="h-[18px] w-[18px] mr-2" alt="logoIcon"></Image>
          <div className="font-semibold text-dashboardText">
            Chapter
          </div>
          </div>
          <div className="flex flex-row h-[48px] items-center pl-2 rounded-[6px]">
          <Image src={help} className="h-[21px] w-[21px] mr-2" alt="logoIcon"></Image>
          <div className="font-semibold text-dashboardText">
            Help
          </div>
          </div>
          <div className="flex flex-row h-[48px] items-center pl-2 rounded-[6px]">
          <Image src={report} className="h-[21px] w-[21px] mr-2" alt="logoIcon"></Image>
          <div className="font-semibold text-dashboardText">
            Report
          </div>
          </div>
          <div className="flex flex-row h-[48px] items-center pl-2 rounded-[6px]">
          <Image src={settings} className="h-[18px] w-[18px] mr-2" alt="logoIcon"></Image>
          <div className="font-semibold text-dashboardText">
            Settings
          </div>
          </div>
      ...
      <div className="flex flex-col">
        <div className="h-[48px] w-full mt-5 flex flex-row justify-between">
          <div className="w-[700px] h-full flex flex-row items-center bg-foreground rounded-[12px] pl-4">
           <Image src={search} className="h-[18px]" alt="searchIcon"></Image>
          ...
          <div className="grid grid-cols-[1fr_1fr_1fr_1fr_3fr] gap-4 items-center mr-10">
            <div className="w-fit">
              <Image src={help} alt="helpIcon"></Image>
            </div>
            <div>
            <Image src={message} alt="messageIcon"></Image>
            </div>
            <div>
            <Image src={setting} alt="settingsIcon"></Image>
            </div>
            <div>
            <Image src={notification} alt="notificationIcon"></Image>
            </div>
            <div className="flex flex-row items-center">
            <Image src={userPic} alt="userPicIcon"></Image>
        ...
        <div className="bg-foreground mt-[20px] h-full rounded-[12px] pl-[15px] pr-[15px] pt-[7px] mr-4">
          <div className="flex flex-col h-full">
            <div className="flex flex-row justify-between items-center">
              ...
              <Image src={plus} className="h-[20px] w-[20px]" alt="plusIcon"></Image>
